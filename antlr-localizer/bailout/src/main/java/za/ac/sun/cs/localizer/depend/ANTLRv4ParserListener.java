...
public interface ANTLRv4ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ANTLRv4Parser#rAltList}.
	 * @param ctx the parse tree
	 */
	void enterRAltList(ANTLRv4Parser.RAltListContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#rAltList}.
	 * @param ctx the parse tree
	 */
	void exitRAltList(ANTLRv4Parser.RAltListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ANTLRv4Parser#empty}.
	 * @param ctx the parse tree
	 */
	void enterEmpty(ANTLRv4Parser.EmptyContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#empty}.
	 * @param ctx the parse tree
	 */
	void exitEmpty(ANTLRv4Parser.EmptyContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ANTLRv4Parser#characterRange_}.
	 * @param ctx the parse tree
	 */
	void enterCharacterRange_(ANTLRv4Parser.CharacterRange_Context ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#characterRange_}.
	 * @param ctx the parse tree
	 */
	void exitCharacterRange_(ANTLRv4Parser.CharacterRange_Context ctx);
	/**
